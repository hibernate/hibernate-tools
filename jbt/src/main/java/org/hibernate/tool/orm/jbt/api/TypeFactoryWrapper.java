...
public interface TypeFactoryWrapper {
	...
	default TypeWrapper getTrueFalseType() { return TypeFactoryWrapperHelper.typeRegistry().get("true_false"); }
	default TypeWrapper getYesNoType() { return TypeFactoryWrapperHelper.typeRegistry().get("true_false"); }
