...
So we add `id 'org.hibernate.tool.hibernate-tools-gradle' version '7.1.20.Final'` to that section.

```groovy
...
plugins {
    ...
    id 'org.hibernate.tool.hibernate-tools-gradle' version '7.1.20.Final'
}
...
```
