...
So we add `id 'org.hibernate.tool.hibernate-tools-gradle' version '7.3.0.CR2'` to that section.

```groovy
...
plugins {
    ...
    id 'org.hibernate.tool.hibernate-tools-gradle' version '7.3.0.CR2'
}
...
```
