...
So we add `id 'org.hibernate.tool.hibernate-tools-gradle' version '6.6.29.Final'` to that section.

```groovy
...
plugins {
    ...
    id 'org.hibernate.tool.hibernate-tools-gradle' version '6.6.29.Final'
}
...
```
