...
So we add `id 'org.hibernate.tool.hibernate-tools-gradle' version '8.0.0.Alpha2'` to that section.

```groovy
...
plugins {
    ...
    id 'org.hibernate.tool.hibernate-tools-gradle' version '8.0.0.Alpha2'
}
...
```
