...
So we add `id 'org.hibernate.tool.hibernate-tools-gradle' version '7.2.0.CR1'` to that section.

```groovy
...
plugins {
    ...
    id 'org.hibernate.tool.hibernate-tools-gradle' version '7.2.0.CR1'
}
...
```
